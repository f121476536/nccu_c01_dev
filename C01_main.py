...
def ParserXMLConfig(_xmldir):
    ...
    xml.c01_camera_save_pic = xml.c01_lib_file_dir + root.find('to_local/c01_camera/save_pic').text
    xml.c01_camera_save_done_pic = xml.c01_lib_file_dir + root.find('to_local/c01_camera/save_done_pic').text
    ...
    xml.run_chrome_para_usr = xml.c01_lib_file_dir + root.find('to_local/run_chrome/para_usr').text
    xml.run_chrome_start_page = root.find('to_local/run_chrome/start_page').text
    xml.usr_lib_account_cache_dir = xml.c01_lib_file_dir + root.find('to_local/lib_account/file_dir').text
